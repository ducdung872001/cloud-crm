...
export const urlsApi = {
  ...
  customer: {
    ...
    telesaleCallList: prefixCustomer + "/telesale-call/list",
    telesaleCallUpdate: prefixCustomer + "/telesale-call/update",
  ...
  invoice: {
    ...
    invoiceDetail: prefixCustomer + "/invoice-detail/import",
    cardService: prefixCustomer + "/invoice-detail/card-service",
    // Tạo hóa đơn bán hàng
    invoiceDetailCustomer: prefixCustomer + "/invoice-detail/customer",
    // Xem chi tiết hóa đơn
    invoiceDetailList: prefixCustomer + "/invoice-detail/list",
    // Hủy hóa đơn
  ...
  product: {
    filterWarehouse: prefixCustomer + "/product/in-warehouse",
  ...
  categoryService: {
    ...
    list: prefixCustomer + "/category-item/list",
    update: prefixCustomer + "/category-item/update",
    detail: prefixCustomer + "/category-item/get",
    delete: prefixCustomer + "/category-item/delete",
  },
