...
moment.locale("vi");
import "./DashboardInvoice.scss";

interface OverViewProps {
  classNames?: string;
}

export default function DashboardInvoice(props: OverViewProps) {
  ...
  return (
    <div className={`overview-invoice d-flex${isCollapsedSidebar ? " overview--sidebar-collapsed" : ""}${classNames ? ` ${classNames}` : ""}`}>
      {overview.map((o, idx) => (
        <div
          key={idx}
