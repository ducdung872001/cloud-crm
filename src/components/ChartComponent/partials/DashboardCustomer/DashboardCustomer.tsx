...
export default function DashboardCustomer(props: OverViewProps) {
  ...
  return (
    <div className={`overview-customer d-flex${isCollapsedSidebar ? " overview--sidebar-collapsed" : ""}${classNames ? ` ${classNames}` : ""}`}>
      {overview.map((o, idx) => (
        <div
          key={idx}
