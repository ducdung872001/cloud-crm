      ...
      {files.length == 0 ? (
        <div className="__action-operation">
          ...
          <div className="btn-upload--file">
            ...
            <input type="file" accept=".doc,.docx,.xls,.xlsx" className="d-none" id="uploadFile" onChange={(e) => handleChangeValueImport(e)} />
          </div>
        </div>
      ) : (
        <div className="show__file--upload">
          ...
          <input type="file" accept=".xls,.xlsx" className="d-none" ref={refInputUpload} onChange={(e) => handleChangeValueImport(e)} />
        </div>
      )}
    </div>
  );
