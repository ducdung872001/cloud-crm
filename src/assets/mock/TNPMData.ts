...
// category: "auth" | "contract" | "billing" | "payment" | "vendor" | "config" | "data" | "security"
export const MOCK_AUDIT_LOGS = [
  {
    id: 1, timestamp: "2024-04-14 09:32:15", userId: 1, userName: "Nguyễn Giám Đốc", userRole: "Giám đốc",
    action: "payment_approved", actionLabel: "Phê duyệt thanh toán NCC",
    entityType: "vendor_payment", entityId: 1, entityRef: "NVAT-2024-001",
    category: "payment", severity: "info",
    ipAddress: "192.168.1.45", userAgent: "Chrome/122 Windows",
    projectId: 6, projectName: "Khu Liên Cơ Quan HC Ba Đình",
    details: "Phê duyệt thanh toán 20.000.000đ cho KT Việt. Workflow step 3/4.",
    beforeState: { status: "pending_director" }, afterState: { status: "pending_treasury" },
  },
  {
    id: 2, timestamp: "2024-04-14 08:15:42", userId: 5, userName: "Phạm Thu Ngân", userRole: "Kế toán",
    action: "debt_collected", actionLabel: "Thu nợ khách hàng",
    entityType: "debt", entityId: 3, entityRef: "HD-2024-011",
    category: "payment", severity: "info",
    ipAddress: "192.168.1.82", userAgent: "Chrome/122 Windows",
    projectId: 1, projectName: "Vinhomes City Park",
    details: "Thu 1.500.000đ từ Nguyễn Thị Hoa (tiền mặt). Còn nợ: 1.920.000đ",
    beforeState: { amount: 1920000 }, afterState: { amount: 420000 },
  },
  {
    id: 3, timestamp: "2024-04-13 16:45:20", userId: 8, userName: "Trần Pháp Chế", userRole: "Pháp chế",
    action: "lease_escalation_applied", actionLabel: "Áp dụng tăng giá thuê",
    entityType: "lease_contract", entityId: 2, entityRef: "HD-THUE-002",
    category: "contract", severity: "warning",
    ipAddress: "192.168.1.90", userAgent: "Chrome/122 Mac",
    projectId: 2, projectName: "Goldmark Office",
    details: "Áp dụng escalation kỳ 2: 50tr → 54tr (+8%) cho ABC Technology",
    beforeState: { rentAmount: 50000000 }, afterState: { rentAmount: 54000000 },
  },
  {
    id: 4, timestamp: "2024-04-13 14:20:10", userId: 2, userName: "Trần Thị Admin", userRole: "Admin",
    action: "vendor_blacklisted", actionLabel: "Chặn nhà cung cấp",
    entityType: "vendor", entityId: 5, entityRef: "NCC-005",
    category: "vendor", severity: "critical",
    ipAddress: "192.168.1.10", userAgent: "Chrome/122 Windows",
    projectId: null, projectName: null,
    details: "Blacklist PCCC HN do vi phạm SLA 3 lần liên tiếp. Lý do: rating < 3.5",
    beforeState: { status: "suspended", blacklisted: false },
    afterState: { status: "suspended", blacklisted: true },
  },
  {
    id: 5, timestamp: "2024-04-13 10:02:33", userId: 5, userName: "Phạm Thu Ngân", userRole: "Kế toán",
    action: "payment_method_created", actionLabel: "Tạo phương thức thanh toán",
    entityType: "payment_method", entityId: 6, entityRef: "momo",
    category: "config", severity: "info",
    ipAddress: "192.168.1.82", userAgent: "Chrome/122 Windows",
    projectId: null, projectName: null,
    details: "Thêm gateway MoMo (chưa active, sandbox mode)",
    beforeState: null, afterState: { enabled: false, environment: "sandbox" },
  },
  {
    id: 6, timestamp: "2024-04-12 22:15:00", userId: 99, userName: "Hệ thống", userRole: "System",
    action: "auto_rule_triggered", actionLabel: "Auto rule kích hoạt",
    entityType: "notification_rule", entityId: 2, entityRef: "RULE-002",
    category: "data", severity: "info",
    ipAddress: "internal", userAgent: "TNPM-Scheduler",
    projectId: null, projectName: null,
    details: "Auto rule 'Nhắc quá hạn 1 ngày' đã gửi 3 thông báo tới KH nợ quá hạn",
    beforeState: null, afterState: { sentCount: 3 },
  },
  {
    id: 7, timestamp: "2024-04-12 15:33:28", userId: 3, userName: "Lê Thu Hằng", userRole: "BQL",
    action: "sr_assigned_vendor", actionLabel: "Phân công SR cho NCC",
    entityType: "service_request", entityId: 3, entityRef: "SR-2024-003",
    category: "data", severity: "info",
    ipAddress: "192.168.1.15", userAgent: "Chrome/122 Windows",
    projectId: 1, projectName: "Vinhomes City Park",
    details: "Phân công SR 'Thang máy block B kêu cọ cọ' cho Otis VN",
    beforeState: { assignedVendorId: null }, afterState: { assignedVendorId: 4 },
  },
  {
    id: 8, timestamp: "2024-04-12 09:18:45", userId: 1, userName: "Nguyễn Giám Đốc", userRole: "Giám đốc",
    action: "login_success", actionLabel: "Đăng nhập thành công",
    entityType: "user", entityId: 1, entityRef: "giamdoc@tnpm.vn",
    category: "auth", severity: "info",
    ipAddress: "192.168.1.45", userAgent: "Chrome/122 Windows",
    projectId: null, projectName: null,
    details: "Đăng nhập qua SSO, tenant: tnpm-main",
    beforeState: null, afterState: null,
  },
  {
    id: 9, timestamp: "2024-04-11 23:45:12", userId: 0, userName: "Hệ thống", userRole: "System",
    action: "failed_login_attempt", actionLabel: "Đăng nhập thất bại",
    entityType: "user", entityId: null, entityRef: "unknown@random.com",
    category: "security", severity: "warning",
    ipAddress: "203.154.xxx.xxx", userAgent: "curl/7.88",
    projectId: null, projectName: null,
    details: "5 lần nhập sai mật khẩu trong 2 phút. Đã tạm khóa IP 30 phút.",
    beforeState: null, afterState: null,
  },
  {
    id: 10, timestamp: "2024-04-11 16:05:30", userId: 1, userName: "Nguyễn Giám Đốc", userRole: "Giám đốc",
    action: "cam_config_updated", actionLabel: "Cập nhật cấu hình CAM",
    entityType: "cam_config", entityId: 1, entityRef: "AEON Mall",
    category: "config", severity: "info",
    ipAddress: "192.168.1.45", userAgent: "Chrome/122 Windows",
    projectId: 4, projectName: "AEON Mall Long Biên",
    details: "Điều chỉnh đơn giá CAM từ 14.000đ/m² → 15.000đ/m² (tăng 7.1%)",
    beforeState: { pricePerM2: 14000 }, afterState: { pricePerM2: 15000 },
  },
  {
    id: 11, timestamp: "2024-04-11 11:22:18", userId: 5, userName: "Phạm Thu Ngân", userRole: "Kế toán",
    action: "invoice_generated_batch", actionLabel: "Tạo hóa đơn hàng loạt",
    entityType: "invoice", entityId: null, entityRef: "BATCH-2024-04",
    category: "billing", severity: "info",
    ipAddress: "192.168.1.82", userAgent: "Chrome/122 Windows",
    projectId: 1, projectName: "Vinhomes City Park",
    details: "Tạo 412 hóa đơn tháng 4/2024 từ meter readings",
    beforeState: null, afterState: { count: 412, totalAmount: 1450000000 },
  },
  {
    id: 12, timestamp: "2024-04-10 08:00:05", userId: 99, userName: "Hệ thống", userRole: "System",
    action: "tenant_isolation_check", actionLabel: "Kiểm tra cô lập dữ liệu",
    entityType: "security", entityId: null, entityRef: "tenant-isolation-scan",
    category: "security", severity: "info",
    ipAddress: "internal", userAgent: "TNPM-SecScan",
    projectId: null, projectName: null,
    details: "Scan row-level security định kỳ — 0 violation detected across 6 projects",
    beforeState: null, afterState: { violations: 0 },
  },
];

// ─── COMPLAINT TICKETS (Phiếu khiếu nại cư dân/tenant) ──────────────────
// Khác với Service Request (kỹ thuật): complaint = phản ánh/khiếu nại hành chính
// severity: "low" | "medium" | "high" | "critical"
// category: "noise" | "security" | "cleanliness" | "staff" | "billing" | "neighbor" | "other"
export const MOCK_COMPLAINT_TICKETS = [
  {
    id: 1, code: "KN-2024-001", projectId: 1, projectName: "Vinhomes City Park",
    customerId: 2, customerName: "Trần Văn Hùng", unitCode: "A-1201",
    category: "noise", categoryLabel: "Tiếng ồn",
    severity: "medium", severityLabel: "Trung bình",
    title: "Căn hộ A-1202 gây tiếng ồn sau 22h",
    description: "Căn hộ bên cạnh (A-1202) tổ chức tiệc liên tục sau 22h từ thứ 6-CN, ảnh hưởng đến gia đình có trẻ nhỏ. Đề nghị BQL nhắc nhở.",
    status: "in_progress", statusLabel: "Đang xử lý",
    assignedTo: "Lê BQL", assignedDept: "Ban quản lý",
    createdAt: "2024-04-10 22:15", dueAt: "2024-04-13 22:15",
    resolvedAt: null, resolution: "",
    attachments: 0, feedbackRating: null,
    priority: 2,
  },
  {
    id: 2, code: "KN-2024-002", projectId: 1, projectName: "Vinhomes City Park",
    customerId: 3, customerName: "Nguyễn Thị Hoa", unitCode: "B-0805",
    category: "security", categoryLabel: "An ninh",
    severity: "high", severityLabel: "Cao",
    title: "Người lạ vào sảnh block B không bị chặn",
    description: "Lúc 19:30 ngày 11/04, một người không có thẻ cư dân đi vào sảnh block B, bảo vệ không kiểm tra. Lo ngại về an ninh.",
    status: "resolved", statusLabel: "Đã xử lý",
    assignedTo: "Trần Bảo Vệ Trưởng", assignedDept: "An ninh",
    createdAt: "2024-04-11 19:45", dueAt: "2024-04-12 19:45",
    resolvedAt: "2024-04-12 15:30",
    resolution: "Đã họp nhân viên bảo vệ, tăng cường kiểm soát thẻ, thay ca trưởng ca tối.",
    attachments: 2, feedbackRating: 4,
    priority: 3,
  },
  {
    id: 3, code: "KN-2024-003", projectId: 4, projectName: "AEON Mall Long Biên",
    customerId: 4, customerName: "Thời Trang Việt", unitCode: "AEON-G001",
    category: "billing", categoryLabel: "Thanh toán/Hóa đơn",
    severity: "medium", severityLabel: "Trung bình",
    title: "Hóa đơn CAM tháng 3 cao bất thường",
    description: "CAM tháng 3 = 1.8M, cao hơn mức trung bình 1.5M các tháng trước. Yêu cầu giải trình và đối chiếu công thức phân bổ.",
    status: "pending", statusLabel: "Chờ xử lý",
    assignedTo: null, assignedDept: "Kế toán",
    createdAt: "2024-04-12 09:00", dueAt: "2024-04-15 09:00",
    resolvedAt: null, resolution: "",
    attachments: 1, feedbackRating: null,
    priority: 2,
  },
  {
    id: 4, code: "KN-2024-004", projectId: 2, projectName: "Goldmark Office",
    customerId: 1, customerName: "ABC Technology", unitCode: "TA-0201",
    category: "cleanliness", categoryLabel: "Vệ sinh",
    severity: "low", severityLabel: "Thấp",
    title: "Vệ sinh sảnh thang máy tầng 2 chưa sạch",
    description: "Sảnh thang máy tầng 2 có vết bẩn và rác sót sau 9h sáng.",
    status: "resolved", statusLabel: "Đã xử lý",
    assignedTo: "Nguyễn Vệ Sinh Trưởng", assignedDept: "Vệ sinh",
    createdAt: "2024-04-09 10:30", dueAt: "2024-04-10 10:30",
    resolvedAt: "2024-04-09 14:00",
    resolution: "Đã nhắc nhở đội vệ sinh, bổ sung thêm 1 lượt lau sàn vào 11h.",
    attachments: 0, feedbackRating: 5,
    priority: 1,
  },
  {
    id: 5, code: "KN-2024-005", projectId: 1, projectName: "Vinhomes City Park",
    customerId: 5, customerName: "Phạm Đức Anh", unitCode: "C-2301",
    category: "staff", categoryLabel: "Thái độ nhân viên",
    severity: "high", severityLabel: "Cao",
    title: "Nhân viên tiếp tân thiếu thiện chí",
    description: "NV tiếp tân ca sáng có thái độ cộc cằn khi cư dân hỏi thông tin. Đề nghị đào tạo lại.",
    status: "in_progress", statusLabel: "Đang xử lý",
    assignedTo: "Hoàng HR Manager", assignedDept: "HR",
    createdAt: "2024-04-13 08:15", dueAt: "2024-04-16 08:15",
    resolvedAt: null, resolution: "",
    attachments: 0, feedbackRating: null,
    priority: 3,
  },
  {
    id: 6, code: "KN-2024-006", projectId: 3, projectName: "KCN Vinh Phúc",
    customerId: 3, customerName: "Samsung VN", unitCode: "F1-001",
    category: "other", categoryLabel: "Khác",
    severity: "critical", severityLabel: "Nghiêm trọng",
    title: "Mất điện nhà máy lúc 14:00 ngày 12/04 — yêu cầu bồi thường",
    description: "Sự cố mất điện 45 phút dẫn đến dừng dây chuyền sản xuất, thiệt hại ước tính 250tr VND. Yêu cầu điều tra nguyên nhân và thương lượng bồi thường.",
    status: "pending", statusLabel: "Chờ xử lý",
    assignedTo: null, assignedDept: "Ban lãnh đạo TNPM",
    createdAt: "2024-04-13 10:00", dueAt: "2024-04-14 10:00",
    resolvedAt: null, resolution: "",
    attachments: 3, feedbackRating: null,
    priority: 4,
  },
];

// ─── STAFF SCHEDULES (Lịch làm việc nhân viên vận hành) ──────────────────
// shiftType: "morning" | "afternoon" | "night" | "fullday"
// dept: "security" | "cleaning" | "technical" | "reception" | "management"
export const MOCK_STAFF_SCHEDULES = [
  {
    id: 1, employeeId: 1, employeeName: "Nguyễn Văn Bảo", dept: "security", deptLabel: "Bảo vệ",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-14", shiftType: "morning", shiftLabel: "Ca sáng",
    startTime: "06:00", endTime: "14:00", position: "Cổng chính",
    status: "scheduled", statusLabel: "Đã lên lịch",
    note: "",
  },
  {
    id: 2, employeeId: 1, employeeName: "Nguyễn Văn Bảo", dept: "security", deptLabel: "Bảo vệ",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-15", shiftType: "morning", shiftLabel: "Ca sáng",
    startTime: "06:00", endTime: "14:00", position: "Cổng chính",
    status: "scheduled", statusLabel: "Đã lên lịch",
    note: "",
  },
  {
    id: 3, employeeId: 2, employeeName: "Lê Văn An", dept: "security", deptLabel: "Bảo vệ",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-14", shiftType: "afternoon", shiftLabel: "Ca chiều",
    startTime: "14:00", endTime: "22:00", position: "Cổng chính",
    status: "in_progress", statusLabel: "Đang làm việc",
    note: "",
  },
  {
    id: 4, employeeId: 3, employeeName: "Trần Thị Sạch", dept: "cleaning", deptLabel: "Vệ sinh",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-14", shiftType: "morning", shiftLabel: "Ca sáng",
    startTime: "05:00", endTime: "13:00", position: "Tòa A + B (sảnh + hành lang)",
    status: "completed", statusLabel: "Đã hoàn thành",
    note: "Bổ sung lau sàn block A sau phản ánh KN-2024-004",
  },
  {
    id: 5, employeeId: 4, employeeName: "Phạm Kỹ Thuật", dept: "technical", deptLabel: "Kỹ thuật",
    projectId: 2, projectName: "Goldmark Office",
    date: "2024-04-14", shiftType: "fullday", shiftLabel: "Full ngày",
    startTime: "08:00", endTime: "17:00", position: "MEP tòa nhà",
    status: "in_progress", statusLabel: "Đang làm việc",
    note: "Bảo trì thang máy + kiểm tra hệ thống điện",
  },
  {
    id: 6, employeeId: 5, employeeName: "Hoàng Tiếp Tân", dept: "reception", deptLabel: "Tiếp tân",
    projectId: 2, projectName: "Goldmark Office",
    date: "2024-04-14", shiftType: "morning", shiftLabel: "Ca sáng",
    startTime: "08:00", endTime: "17:00", position: "Lobby tầng 1",
    status: "completed", statusLabel: "Đã hoàn thành",
    note: "",
  },
  {
    id: 7, employeeId: 6, employeeName: "Ngô Đêm Khuya", dept: "security", deptLabel: "Bảo vệ",
    projectId: 4, projectName: "AEON Mall Long Biên",
    date: "2024-04-14", shiftType: "night", shiftLabel: "Ca đêm",
    startTime: "22:00", endTime: "06:00", position: "TTTM + bãi xe",
    status: "scheduled", statusLabel: "Đã lên lịch",
    note: "",
  },
  {
    id: 8, employeeId: 4, employeeName: "Phạm Kỹ Thuật", dept: "technical", deptLabel: "Kỹ thuật",
    projectId: 2, projectName: "Goldmark Office",
    date: "2024-04-15", shiftType: "fullday", shiftLabel: "Full ngày",
    startTime: "08:00", endTime: "17:00", position: "HVAC tòa nhà",
    status: "scheduled", statusLabel: "Đã lên lịch",
    note: "Kiểm tra điều hòa trung tâm",
  },
  {
    id: 9, employeeId: 7, employeeName: "Vũ BQL", dept: "management", deptLabel: "Quản lý",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-14", shiftType: "fullday", shiftLabel: "Full ngày",
    startTime: "08:00", endTime: "17:30", position: "Văn phòng BQL",
    status: "in_progress", statusLabel: "Đang làm việc",
    note: "Họp khách — xử lý KN-2024-001",
  },
  {
    id: 10, employeeId: 3, employeeName: "Trần Thị Sạch", dept: "cleaning", deptLabel: "Vệ sinh",
    projectId: 1, projectName: "Vinhomes City Park",
    date: "2024-04-15", shiftType: "morning", shiftLabel: "Ca sáng",
    startTime: "05:00", endTime: "13:00", position: "Tòa C + D",
    status: "scheduled", statusLabel: "Đã lên lịch",
    note: "",
  },
];
