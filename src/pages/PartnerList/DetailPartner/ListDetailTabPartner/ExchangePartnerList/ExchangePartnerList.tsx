...
import "./ExchangePartnerList.scss";
...
export default function ExchangePartnerList(props: any) {
  ...
  const getListExchange = async (pageProps?: number) => {
    ...
    const response = await PartnerService.partnerExchangeList(params);
  ...
  const onRemoveChat = async (id) => {
    ...
    const response = await PartnerService.partnerExchangeDelete(id);
  ...
  return (
    <div className="wrapper-exchange-partner">
