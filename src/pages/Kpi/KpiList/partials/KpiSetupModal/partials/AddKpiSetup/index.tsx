...
import { IKpiSetupRequest } from "model/kpiSetup/KpiSetupRequestModel";
 ...
 * @returns 
 */
export default function AddKpiSetup(props: IKpiSetupModalProps) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: IKpiSetupRequest = {
      ...(formData as IKpiSetupRequest),
      ...(data ? { id: data.id } : {})
    };

    const response = await KpiSetupService.update(body);
  ...
  return (
    <form className="form__add--kpi-setup" onSubmit={onSubmit}>
