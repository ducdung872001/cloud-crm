...
export default function OnHoldModal(props: Record<string, unknown>) {
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-onhold-modal"
        // size="lg"
      >
        <form
          className="form-onhold-modal"
              ...
              <div className="list-field-item list-field-basic">
                <div className="box_line_date">
                  <span className="title_time">
                    Thời gian tạm dừng <span style={{ color: "red" }}>*</span>:
                  </span>
                      ...
                      <div className="form-group">
                        <NummericInput
                          ...
                          onChange={(e) => {
                            ...
                            setFormData({ ...formData, values: { ...formData.values, day: value } });
                          }}
                        />
                      </div>
                      <div>
                    ...
                    <div className="box_time">
                      <div className="form-group">
                        <NummericInput
                          ...
                          // label="Số lượng thực tế"
                          fill={false}
                          value={formData.values.hour}
                          onChange={(e) => {
                            const value = e.target.value || "";
                            setFormData({ ...formData, values: { ...formData.values, hour: value } });
                          }}
                        />
                      </div>
                      <div>
                    ...
                    <div className="box_time">
                      <div className="form-group">
                        <NummericInput
                          ...
                          // label="Số lượng thực tế"
                          fill={false}
                          value={formData.values.minute}
                          onChange={(e) => {
                            const value = e.target.value || "";
                            setFormData({ ...formData, values: { ...formData.values, minute: value } });
                          }}
                        />
                      </div>
                      <div>
