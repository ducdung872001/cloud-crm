...
import { ICustomerGroupRequest } from "model/customerGroup/CustomerGroupRequestModel";
import { AddCustomerGroupModalProps } from "model/customerGroup/PropsModel";
...
export default function AddCustomerGroupModal(props: AddCustomerGroupModalProps) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: ICustomerGroupRequest = {
      ...(formData.values as ICustomerGroupRequest),
      ...(data ? { id: data.id } : {}),
    };
