...
export default function AddProjectModal(props: any) {
  ...
  const onSubmit = async (e) => {
    ...
    const response = await OperationProjectService.update(body);
    ...
    <Fragment>
      ...
      >
        <form className="form-branch-group" onSubmit={(e) => onSubmit(e)}>
          <ModalHeader title={`${data ? "Chỉnh sửa" : "Thêm mới"} dự án`} toggle={() => !isSubmit && onHide(false)} />
          <ModalBody>
