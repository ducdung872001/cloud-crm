...
export default function ConfigEmail(props: any) {
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-condition-email"
        size="lg"
      >
        <form className="form-condition-email">
          ...
          <ModalBody>
            <div className="container-condition-email">
