...
export default function ChartActionCumulative(props: ReportRevenueProps) {
  ...
  const [chartData, setChartData] = useState({
    ...
    series: [
      {
        name: "Số tin nhắn lỗi",
        data: [100, 180, 260, 320, 400],
        color: chartColor.today,
      },
      {
        name: "Số tin nhắn gửi thành công",
        data: [100, 200, 300, 400, 500],
        color: chartColor.success,
      },
      {
        name: "Số tin nhắn đã gửi",
        data: [100, 300, 500, 800, 1000],
        color: chartColor.total,
      },
    ],
    exporting: {
      allowHTML: true,
  ...
  return (
    <div className={`card-box report-revenue${classNames ? ` ${classNames}` : ""}`}>
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Tỉ lệ tương tác lũy kế</h2>
        <div
