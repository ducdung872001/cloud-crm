...
export default function ChartCustomerType(props) {
    ...
    series: [
      {
        ...
        data: [
          {
            name: "Nhóm thu nhập cao",
            y: 100,
            text: "100 tin nhắn",
          },
          {
            name: "Nhóm thu nhập trung bình",
            y: 200,
            text: "200 tin nhắn",
          },
          {
  ...
  return (
    <div className="card-box page__customer--campaign chart-report__detail">
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Phân bổ gửi tin nhắn theo nhóm khách hàng</h2>
        <div
