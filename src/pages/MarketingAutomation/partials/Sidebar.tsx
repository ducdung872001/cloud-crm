...
export default (props) => {
  ...
  const conditionData = [
    {
      label: "Điều kiện Email",
      code: 'email_condition',
      type: 'condition'
    },
    {
      label: "Điều kiện SMS",
    ...
    {
      label: "Điều kiện Zalo",
      code: 'zalo_condition',
      type: 'condition'
    },
    {
      label: "Điều kiện Call",
      code: 'call_condition',
      type: 'condition'
    },
    {
    ...
    <aside>
      <div className="condtion-sidebar">
        ...
        >
          ...
          {/* <span className="icon-up-down">{isShowCondition ? <Icon name="ChevronDown" /> : <Icon name="ChevronRight" />}</span> */}
        </div>
      ...
      <div className="condtion-sidebar">
        ...
        >
          ...
          {/* <span className="icon-up-down">{isShowAction? <Icon name="ChevronDown" /> : <Icon name="ChevronRight" />}</span> */}
        </div>
