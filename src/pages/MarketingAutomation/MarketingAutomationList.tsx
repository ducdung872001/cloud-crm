...
import AddMAModal from "./AddMAModal/AddMAModal";
import MarketingAutomationService from "services/MarketingAutomationService";
import ReportMa from "./ReportMa/ReportMa";
import InitBpmModal from "./InitBpmModal";

export default function MarketingAutomationList() {
  document.title = "Danh sách Marketing Automation";
