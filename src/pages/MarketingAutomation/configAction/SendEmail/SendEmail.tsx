            ...
            <RadioList
              ...
              onChange={(e) => {
                ...
                if (value === "1") {
                  ...
                  setFormData({ ...formData, values: { ...formData.values, type: value, title: "" } });
                  setDesContent("");
                } else {
    ...
    <Fragment>
      ...
      >
        <form className="form-email">
          <ModalHeader title={dataNode?.name} toggle={() => !isSubmit && handleClose()} />
          <ModalBody>
              ...
              <div className="list-form-group">
                ...
                {/* <div className="list-code-email">
                  {listCodeEmail.map((item, idx) => (
                    <span key={idx} className="name-code" 
                      onClick={() => handlePointerContent(item)}
                    >
                      {item.name}
                    </span>
                  ))}
                ...
                <div className="form-group">
                  <RebornEditor
                    ...
                    initialValue={desContent ? desContent : ""}
      ...
      <ViewTemplateEmailModal
        ...
        onHide={(reload) => {
          if (!reload && !desContent) {
            setFormData({ ...formData, values: { ...formData.values, type: "1", title: "" } });
            setDesContent("");
          }
          setShowModalViewTemplateEmail(false);
        }}
