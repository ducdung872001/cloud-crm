...
export default function QuantityNonInteractionDay(props) {
    ...
    series: [
      {
        ...
        data: [
          ...
          // },
          // {
          //   name: "1 lần tương tác",
          //   y: 9.47,
          //   sum: 60,
          // },
          // {
          //   name: "2-3 lần tương tác",
          //   y: 9.32,
          //   sum: 46,
          // },
          // {
          //   name: "3 - 7 lần tương tác",
          //   y: 8.15,
          //   sum: 28,
          // },
          // {
  ...
  const handGetQuantityNonInteractionDay = async () => {
    const param = {
      branchId,
    };

    const response = await CustomerService.classifyInteractTimes(param);
    ...
    if (response.code === 0) {
      ...
      showToast("Báo cáo theo số lần tương tác lỗi. Vui lòng xem lại sau!", "error");
    }
  };

  useEffect(() => {
    handGetQuantityNonInteractionDay();
  }, []);
    ...
    if (chart && valueOption !== "excel") {
      ...
      chart.update({
        exporting: {
          ...
          filename: `${valueOption.startsWith("image") ? "Ảnh" : "Báo_cáo"}_theo_số_lần_tương_tác`, // Tên file
  ...
  return (
    <div className="page__quantity__noninteraction--day">
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Theo số lần tương tác</h2>
        <div
