...
export default function InteractedAcrossChannels(props) {
    ...
    if (chart && valueOption !== "excel") {
      ...
      chart.update({
        exporting: {
          ...
          filename: `${valueOption.startsWith("image") ? "Ảnh" : "Báo_cáo"}_từng_tương_tác_qua_kênh`, // Tên file
  ...
  return (
    <div className="page__interacted__across__channels">
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Từng tương tác qua kênh</h2>
        <div
