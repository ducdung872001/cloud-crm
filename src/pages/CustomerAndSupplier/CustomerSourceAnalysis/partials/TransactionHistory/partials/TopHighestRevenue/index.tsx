...
export default function TopHighestRevenue(props) {
  ...
  const handGetHighestRevenue = async () => {
    const param = {
      branchId,
      limit: 5,
    };

    const response = await CustomerService.classifyTopRevenue(param);
