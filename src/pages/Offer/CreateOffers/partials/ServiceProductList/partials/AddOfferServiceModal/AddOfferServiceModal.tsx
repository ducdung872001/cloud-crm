...
import { AddOfferServiceProps } from "model/offerService/PropsModel";
import { IFieldCustomize, IFormData, IValidation } from "model/FormModel";
import { IServiceFilterRequest } from "model/service/ServiceRequestModel";
import { IOfferServiceRequest } from "model/offerService/OfferServiceRequestModel";
...
export default function AddOfferServiceModal(props: any) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: IOfferServiceRequest = {
      ...(formData.values as IOfferServiceRequest),
      ...(data ? { id: data.id } : {}),
    };
    ...
    const response = await OfferServiceService.update(body);
    ...
    <Fragment>
      ...
      >
        <form className="form-add-bought-service" onSubmit={(e) => onSubmit(e)}>
          <ModalHeader
            title={`${data ? "Chỉnh sửa" : "Thêm mới"} dịch vụ báo giá`}
            toggle={() => {
