...
export default function AddPromotionBundleModal(props: IAddCategoryServiceModelProps) {
  ...
  const values = useMemo(
    () => {
      ...
      return {
        ...
        origPrice: d?.orig ? parseInt(d.orig.replace(/\./g, '')) : 0,
  ...
  const validations: IValidation[] = [
    ...
    { name: "products", rules: "required" },
    { name: "origPrice", rules: "required" },
    { name: "salePrice", rules: "required" },
  ...
  const listField: IFieldCustomize[] = [
    {
      ...
      fill: true,
      required: true,
      placeholder: "VD: Combo Gia đình, Combo Tiết kiệm...",
    },
    {
      label: "Danh sách sản phẩm cấu thành",
      name: "products",
      type: "text",
      fill: true,
      required: true,
      placeholder: "VD: Sản phẩm A, Sản phẩm B",
    },
    {
      label: "Giá gốc của các sản phẩm cộng lại (VNĐ)",
      name: "origPrice",
      type: "number",
      fill: true,
      required: true,
