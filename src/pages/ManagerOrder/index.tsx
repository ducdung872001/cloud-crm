...
import SaleFlowModal from "components/saleFlowModal/saleFlowModal";
...
export default function ManageOrder() {
  ...
  const [onShowModalSaleFlow, setOnShowModalSaleFlow] = useState<boolean>(false);
  const [itemSaleFlow, setItemSaleFlow] = useState(null);
  ...
  const actionsTable = (item: IOrderResponseModel): IAction[] => {
    return [
      ...
      },
      {
        ...
        callback: () => {
          setOnShowModalSaleFlow(true);
          setItemSaleFlow(item);
        },
      },
      {
        title: "Hủy hóa đơn",
  ...
  return (
    ...
    >
      ...
      />
      <SaleFlowModal itemSaleFlow={itemSaleFlow} onShow={onShowModalSaleFlow} onHide={() => setOnShowModalSaleFlow(false)} />
