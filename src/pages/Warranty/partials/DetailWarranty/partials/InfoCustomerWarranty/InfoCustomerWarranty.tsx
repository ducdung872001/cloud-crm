...
import { IInfoCustomerWarrantyProps } from "model/warranty/PropsModel";
import "./InfoCustomerWarranty.scss";

export default function InfoCustomerWarranty(props: IInfoCustomerWarrantyProps) {
  const { data } = props;
      ...
      <div className="info-right">
        <div className="info-customer-item">
          <div className="show-service">
            <Input label="Dịch vụ bảo hành" defaultValue={data.serviceName} disabled={true} fill={true} />
          </div>
          <div className="show-reason">
            <Input label="Lý do bảo hành" defaultValue={data.reasonName} disabled={true} fill={true} />
          </div>
          <Fancybox>
            <div className="show-image">
              {data.docLink.length > 0
