...
const KanbanWarrantyProcess = (props: Record<string, unknown>) => {
              ...
              <div className={`task-infomation`}>
                <div style={{ display: "flex", cursor: "pointer" }}>
                  ...
                  <div>
                    <span style={{ fontSize: 12, fontWeight: "500", marginLeft: 5 }}>
                      {orderRequest?.note ? orderRequest?.note : "Không tìm thấy yêu cầu bảo hành"}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  <span style={{ fontSize: 12, fontWeight: "400" }}>
                    Thời gian tạo: {orderRequest?.createdAt ? formatDateCustom(orderRequest?.createdAt, "EEEEEE/MM/yyyy  HH:mm") : ""}
                  </span>
                </div>
