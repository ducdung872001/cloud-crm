...
export default function ContentChat(props: IContentChatProps) {
  const { dataMessage, sieId, employeeId, onHide } = props;
  ...
  useEffect(() => {
    if (employeeId || sieId) {
      setMessageChat({ ...messageChat, employeeId: employeeId, sieId: sieId });
    }
  }, [employeeId, sieId]);
  ...
  const handleSendChat = async (e) => {
    ...
    const response = await SaleflowInvoiceService.addInvoiceExchange(body);
