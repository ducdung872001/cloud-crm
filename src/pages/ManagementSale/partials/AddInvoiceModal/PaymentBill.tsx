...
import ShowPaymentBillModal from "./patials/ShowPaymentBillModal/ShowPaymentBillModal";
...
export default function PaymentBill(props: any) {
  ...
  useEffect(() => {
    setFormData({
      ...
      saleflowId: dataPaymentBill.saleflowId,
      receiptDate: dataPaymentBill.receiptDate
    });
  ...
  const handleChangeValueSaleflow = (e) => {
    ...
    setDetailSaleflow(e);
    setFormData({ ...formData, saleflowId: e.value });
  };
  ...
  const onSubmit = async (e) => {
    ...
    if(saleflowId === -1 && !formData?.saleflowId){
      showToast("Vui lòng chọn quy trình bán hàng", "error");
      return
    }
  ...
  return (
    <div className="payment__bill--item">
      ...
      <form className="form__payment--bill" >
        ...
        <div className="action__apply--payment">
          ...
          >
            {dataInvoice ? 'Cập nhật' : 'Tạo đơn bán'}
