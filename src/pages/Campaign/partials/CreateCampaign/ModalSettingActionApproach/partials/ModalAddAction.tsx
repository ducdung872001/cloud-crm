  ...
  useEffect(() => {
    if (activityData) {
      ...
      setDetailAction({
        ...
        label:
          activityData.code === "email"
            ? "Email"
            : activityData.code === "sms"
            ? "SMS"
            : activityData.code === "call"
            ? "Gọi điện"
            : activityData.code === "zalo"
            ? "Zalo"
            : activityData.code === "face"
            ? "Gặp trực tiếp"
            : activityData.code === "schedule"
            ? "Đặt lịch"
            : activityData.code === "contact"
            ? "Đầu mối làm việc"
            : activityData.code === "collectInfo"
            ? "Thu thập thông tin"
            : activityData.code === "voc"
            ? "Thu thập VOC"
            : "",
      });
