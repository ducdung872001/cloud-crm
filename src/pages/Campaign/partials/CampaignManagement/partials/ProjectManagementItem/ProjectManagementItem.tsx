...
export default function ProjectManagementItem(props: IProjectManagementItemProps) {
  const {
    data,
    idProjectManagement,
  ...
  useEffect(() => {
    if (isShowChildrenProject && data?.id === idProjectManagement) {
      getDetailProject(idProjectManagement);
    }
  }, [isShowChildrenProject, data, idProjectManagement]);

  // console.log("đk final : ", isShowChildrenProject && listProjectChildren && listProjectChildren.length > 0);
  // console.log("đk 1 : ", isShowChildrenProject);
  // console.log("đk 2 : ", listProjectChildren);
