...
export default function ChartJobProcess(props: ReportRevenueProps) {
  ...
  const [chartData, setChartData] = useState({
    ...
    xAxis: {
      categories: ["01/08/2024", "02/08/2024", "03/08/2024", "04/08/2024", "05/08/2024", "06/08/2024", "07/08/2024"],
      crosshair: true,
    },
    yAxis: {
      min: null,
    ...
    series: [
      {
        name: "Doanh thu",
        data: [40000000, 20000000, 5000000, 25000000, 10000000],
        color: chartColor.early,
      },
      {
        name: "Chi phí",
        data: [20000000, 30000000, 40000000, 5000000, 5000000],
        color: "red",
      },
      {
        name: "Lợi nhuận lũy kế",
        data: [20000000, -10000000, -35000000, 20000000, 5000000],
  ...
  return (
    <div className={`card-box report-profit${classNames ? ` ${classNames}` : ""}`}>
      <div className="title__common d-flex align-items-start">
        <div className="title">
          <h2 className="name-common">Diễn biến doanh thu - chi phí - lợi nhuận lũy kế</h2>
