        ...
        <div className="show__file--upload">
          <div className="img__upload">
            ...
            <div style={{ width: "85%" }}>
              ...
              {/* <h5 style={{ fontSize: 14 }}>{files[0]?.name ? files[0]?.name : `TaiLieu.${infoFile?.extension}`}</h5> */}
              <h5 style={{ fontSize: 14 }}>{infoFile?.name ? infoFile?.name : `TaiLieu.${infoFile?.extension}`}</h5>
              {templateGetApi ? (
                <Tippy content="Tải xuống">
                  <div className="download" onClick={() => download(infoFile?.fileUrl, "TaiLieu")}>
