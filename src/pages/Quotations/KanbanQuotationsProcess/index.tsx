                ...
                <div style={{ display: "flex", cursor: "pointer" }}>
                  ...
                  <div>
                    <span style={{ fontSize: 12, fontWeight: "500", marginLeft: 5 }}>
                      {orderRequest?.note ? orderRequest?.note : "Không tìm thấy danh sách báo giá"}
                    </span>
                  </div>
                </div>
...
export default memo(KanbanQuotationsProcess);
