...
import { IAddPartnerSMSModelProps } from "model/partnerSMS/PropsModel";
import { IPartnerSMSRequestModel } from "model/partnerSMS/PartnerSMSRequestModel";
...
import "./AddPartnerSMSModel.scss";

export default function AddPartnerSMSModel(props: IAddPartnerSMSModelProps) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: IPartnerSMSRequestModel = {
      ...(formData.values as IPartnerSMSRequestModel),
      ...(data ? { id: data.id } : {}),
    };

    const response = await PartnerSMSService.update(body);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-add-partnersms"
      >
        <form className="form-partnersms-group" onSubmit={(e) => onSubmit(e)}>
