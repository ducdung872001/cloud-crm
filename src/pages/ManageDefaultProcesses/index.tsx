...
export default function ManageDefaultProcesses(props: Record<string, unknown>) {
  ...
  let options = [
    ...
    { value: "/contract-warranty/", label: "Danh sách bảo hành" },    
    { value: "/ma/", label: "Truyền thông theo kịch bản" },
    { value: "/campaign-opportunity/", label: "Quản lý cơ hội" },
    { value: "/order-request/", label: "Xác nhận đơn hàng" },
    { value: "/treatment-history/", label: "Lịch sử thực hiện dịch vụ" },
