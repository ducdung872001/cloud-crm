...
import { IMessageChatOpportunityProps, IMessageChatOpportunityRequestModal } from "model/campaignOpportunity/CampaignOpportunityRequestModel";
import CampaignOpportunityService from "services/CampaignOpportunityService";

export default function MessageChat(props: IMessageChatOpportunityProps) {
  const { coyId, employeeId, takeHeightTextarea, onHide, dataMessage } = props;
  ...
  const [messageChat, setMessageChat] = useState<IMessageChatOpportunityRequestModal>({
    content: "",
    coyId: coyId,
  });
  ...
  const handleSendChat = async (e) => {
    ...
    const body: IMessageChatOpportunityRequestModal = {
      ...(messageChat as IMessageChatOpportunityRequestModal),
    };
