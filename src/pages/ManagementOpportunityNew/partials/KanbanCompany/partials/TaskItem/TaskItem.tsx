        ...
        {(provided, snapshot) => (
          ...
          >
            ...
            <div className={`task-infomation `}>
              {/* <h4 className="title--job">{item.opportunity?.productName || item.opportunity?.serviceName}</h4> */}
              <div style={{ display: "flex", width: "100%", justifyContent: "space-between" }}>
                <Tippy content={<TippyCustomerInfo detailCustomer={item} />} delay={[120, 100]} animation="scale" interactive={true}>
                  <div style={{ cursor: "pointer" }}>
                    <h4 className="title--job">{item?.customerTrademark || item.opportunity?.customerName || ""}</h4>
                    {/* <h4 className="title--job">{item.opportunity?.productName || item.opportunity?.serviceName}</h4> */}
                  </div>
                </Tippy>
              ...
              <div>
                <span style={{ fontSize: 14, fontWeight: "500" }}>{item.opportunity?.productName || item.opportunity?.serviceName}</span>
              </div>

              <div>
                <span style={{ fontSize: 12, fontWeight: "500" }}>{item.opportunity?.contactName}</span>
              </div>
              {item.saleName && (
