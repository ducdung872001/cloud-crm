...
export default function InstallApplication() {
  ...
  const [listSaveSearch] = useState<ISaveSearch[]>([
    {
      key: "all",
      name: "Danh sách cài đặt ứng dụng",
      is_active: true,
    },
  ]);
  ...
  return (
    <div className={`page-content page-install--app${isNoItem ? " bg-white" : ""}`}>
      <TitleAction title="Cài đặt ứng dụng" titleActions={titleActions} />
