...
export default function ChartRateJobEmployee(props: ReportRevenueProps) {
  ...
  const [chartData, setChartData] = useState({
    ...
    xAxis: {
      categories: ["Hoàng Lâm", "Hoàng Nam", "Cao Huy Đông", "Văn Trung", "Hoàng Thị Phượng"],
    },
    yAxis: {
      min: 0,
      title: {
    ...
    series: [
      // {
      //   name: "Motorcycles",
      //   data: [74, 27, 52, 93, 172],
      // },
      {
        name: "Tỉ lệ hoàn thành công việc đúng hạn",
        data: [100, 60, 90, 100, 30],
        color: "#015aa4",
      },
      // {
      //   name: "Đã hoàn thành",
  ...
  return (
    <div className={`card-box report-revenue${classNames ? ` ${classNames}` : ""}`}>
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Tỉ lệ hoàn thành công việc đúng hạn</h2>
        <div
