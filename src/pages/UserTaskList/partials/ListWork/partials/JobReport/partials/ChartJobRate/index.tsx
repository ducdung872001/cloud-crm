  ...
  const [chartData, setChartData] = useState({
    ...
    series: [
      ...
      // value là giá trị thật sự, unit là đơn vị hiển thị
      {
        ...
        data: [
          { y: 45, value: 75, unit: "công việc" },
          { y: 47, value: 23, unit: "MM" },
          { y: 65, value: 55, unit: "ngày" },
        ],
      ...
      },
      {
        name: "Đã hoàn thành",
        data: [
          { y: 55, value: 50, unit: "công việc", id: "min" },
          { y: 53, value: 13, unit: "MM" },
          { y: 35, value: 45, unit: "ngày" },
        ],
