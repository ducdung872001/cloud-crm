...
export default function ModalSelectJump(props: any) {
      ...
      [
        {
          ...
          options: [
            {
              value: "normal",
              label: "Kích hoạt thông thường",
            },
            {
              value: "jump",
              label: "Kích hoạt Jump",
            },
            {
              value: "jump_to_first",
              label: "Kích hoạt Jump về bước đầu tiên",
            },
          ],
        },
      ] as IFieldCustomize[],
  ...
  const onSubmit = async (e) => {
    ...
    onHide(true, formData.values.isJump)
  };
      ...
      actions_right: {
        buttons: [
          ...
          },
          {
            ...
            type: "submit",
            color: "primary",
            disabled: isSubmit || !formData.values.isJump,
            is_loading: isSubmit,
          },
        ],
      },
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-select-jump"
        size="sm"
      >
        <form className="form-select-jump" onSubmit={(e) => onSubmit(e)}>
          <ModalHeader
            title={`Kích hoạt`}
            toggle={() => {
              handClearForm(false);
