      ...
      dataOption &&
        ...
        dataOption.map((item) => {
          ...
          components.map((el) => {
            ...
            //   });
            // } else {
            //   if(el.type === "dynamiclist" && el.components && el.components.length > 0){
            //     el.components.map(el => {
            //       listForm.push({
            //         value: `frm_${item.code}.${el.key}`,
            //         label: `frm_${item.code}.${el.key}`,
            //         nodeId: item.nodeId,
            ...
            <div className="list-form-group">
              ...
              >
                <div className="icon-check">
                  <Icon name={formData?.ruleValidation === 0 ? "Test" : "Checked"} style={{ width: 20, height: 20, fill: "var(--primary-color)" }} />
                </div>
                <div>
                                                ...
                                                {!el.typeValue ? (
                                                  ...
                                                  <div className="select-mapping">
                                                    <SelectCustom
                                                      ...
                                                      special={true}
                                                      required={true}
                                                      onChange={(e) => handChangeValueTypeItem(e, idx, el.typeValue === 1 ? "form" : "var", idxList)}
                                                      isAsyncPaginate={true}
                                                      isFormatOptionLabel={false}
