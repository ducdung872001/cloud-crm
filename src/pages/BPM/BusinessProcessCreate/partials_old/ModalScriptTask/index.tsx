...
export default function ModalScriptTask({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailScriptTask(id);
  ...
  const values = useMemo(
    () => ({
      ...
      scriptLanguage: data?.scriptLanguage ?? "JavaScript",
  ...
  const onSubmit = async (e) => {
    ...
    const body = {
      ...
      scriptLanguage: formData?.scriptLanguage ?? "JavaScript",
      scriptBody: formData?.scriptBody ?? "",
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-script-task"
      >
        <form className="form-script-task" onSubmit={(e) => onSubmit(e)}>
            ...
            <div className="list-form-group">
              ...
              <div className="form-group">
                <SelectCustom
                  ...
                  options={[
                    ...
                    {
                      value: "Ngôn ngữ tùy chỉnh của hệ thống BPM.",
                      label: "Ngôn ngữ tùy chỉnh của hệ thống BPM.",
                    },
                  ]}
                  value={formData.scriptLanguage ? { value: formData.scriptLanguage, label: formData.scriptLanguage } : null}
                  onChange={(e) => {
                    setFormData({ ...formData, scriptLanguage: e.value });
                  }}
                  isAsyncPaginate={false}
                  isFormatOptionLabel={false}
                  placeholder="Chọn ngôn ngữ script "
                />
              </div>
              ...
              <div className="form-group">
                <TextArea
                  ...
                  label="Đoạn mã script"
                  fill={true}
                  onChange={(e) => {
                    const value = e.target.value;
                    setFormData({ ...formData, scriptBody: value });
                  }}
                  placeholder="Nhập đoạn mã script"
                />
              </div>
              ...
              <div className="form-group">
                <Input
                  id="scope"
                  name="scope"
                  label="Phạm vi/Ngữ cảnh"
                  fill={true}
                  required={true}
                  placeholder={"Phạm vi/Ngữ cảnh"}
