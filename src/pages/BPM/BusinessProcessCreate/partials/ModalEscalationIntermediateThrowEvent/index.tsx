...
export default function ModalEscalationIntermediateThrowEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
 ...
 const getDetailTask = async (id) => {
   const response = await BusinessProcessService.detailEscalationIntermediateThrowEvent(id);
 ...
 return (
   <Fragment>
     <Modal
       ...
       className="modal-escalation-intermediate-throw-event"
     >
