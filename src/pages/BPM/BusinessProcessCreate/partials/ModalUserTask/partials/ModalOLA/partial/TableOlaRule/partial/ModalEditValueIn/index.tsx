...
export default function ModalEditValueIn({ onShow, onHide, dataFieldEdit, setDataRow, handChangeValueItem }) {
  ...
  const actions = useMemo<IActionModal>(
        ...
        buttons: [
          ...
          },
          {
            ...
            callback: async () => {
              ...
              handChangeValueItem(dataFieldEdit.rowIndex, dataFieldEdit.fieldIndex, dataNew, "value_in");
              clearForm(true);
            },
          },
        ],
    ...
    [isSubmit, addFieldAttributes, dataFieldEdit.type]
  );
  ...
  const handleChangeValueAttributeItem = (value, idx) => {
                          ...
                          <div className="form-group">
                            {dataFieldEdit?.type === "number" ? (
                              <NummericInput
                                ...
                                onValueChange={(e) => handleChangeValueAttributeItem(e?.floatValue, idx)}
                              ...
                              <Input
                                ...
                                onChange={(e) => handleChangeValueAttributeItem(e?.target?.value, idx)}
                              />
                            )}
                          </div>
                        </div>
