...
import "./ModalConditionalStartEvent.scss";
...
export default function ModalConditionalStartEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailConditionalStartEvent(id);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-conditional-start-event"
      >
        <form className="form-conditional-start-event" onSubmit={(e) => onSubmit(e)}>
