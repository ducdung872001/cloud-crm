...
import TableHeaderAdvance from "./partial/TableHeaderAdvance";
import ModalAddDecisionRule from "./partial/ModalAddDecision";
import TableBodyAdvance from "./partial/TableBodyAdvance";

export default function TableDecisionRule({ processId, childProcessId, dataConfigAdvance, setDataConfigAdvanceEdit, setHaveError }) {
