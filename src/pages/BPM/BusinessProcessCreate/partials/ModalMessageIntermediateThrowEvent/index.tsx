...
export default function ModalMessageIntermediateThrowEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailMessageIntermediateThrowEvent(id);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-message-intermediate-throw-event"
      >
        <form className="form-message-intermediate-throw-event" onSubmit={(e) => onSubmit(e)}>
