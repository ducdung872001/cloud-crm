...
export default function ModalSignalIntermediateCatchEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    const response = await BusinessProcessService.detailSignalIntermediateCatchEvent(id);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-signal-intermediate-catch-event"
      >
        <form className="form-signal-intermediate-catch" onSubmit={(e) => onSubmit(e)}>
              ...
              <div className="form-group" style={{ width: "100%" }}>
                ...
                <div className="box-input-message">
                  ...
                  <Input
                    ...
                    placeholder="Định danh thông điệp (Topic)"
                  />
                </div>
              </div>
