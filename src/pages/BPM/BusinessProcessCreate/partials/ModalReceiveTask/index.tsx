...
export default function ModalReceiveTask({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const getDetailTask = async (id) => {
    ...
    if (response.code == 0) {
      ...
      if (result?.messageId) {
        ...
        // tìm vị trí của "bpm-receive-message-"
        const prefix = "bpm-receive-message-";
  ...
  const onSubmit = async (e) => {
    ...
    const body = {
      ...
      messageName: data?.messageName ?? "",
      messageId: `bpm-receive-message-${formData?.messageId}` ?? "",
            ...
            <div className="list-form-group">
              ...
              <div className="form-group" style={{ width: "100%" }}>
                ...
                <div className="box-input-message">
                  <span style={{ fontSize: 14, fontWeight: "400" }}>bpm-receive-message-</span>
                  <Input
                    name="messageId"
