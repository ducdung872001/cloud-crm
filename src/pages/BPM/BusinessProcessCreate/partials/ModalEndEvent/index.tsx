...
export default function ModalEndEvent({ onShow, onHide, dataNode, processId, changeNameNodeXML, disable }) {
  ...
  const onSubmit = async (e) => {
    ...
    const response = await BusinessProcessService.updateEndTaskEvent(body);
