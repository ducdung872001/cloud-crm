      ...
      actions_right: {
        buttons: [
          ...
          },
          {
            ...
            type: "submit",
            color: "primary",
            disabled: isSubmit || !isDifferenceObj(formData, values) || listEformAttribute.length === 0,
            is_loading: isSubmit,
          },
        ],
      },
    }),
    [formData, values, isSubmit, listEformAttribute]
  );
    ...
    <Fragment>
      ...
      >
        <form className="form-add-form-type-group" onSubmit={(e) => onSubmit(e)}>
          <ModalHeader title={`Cài đặt hành động`} toggle={() => !isSubmit && onHide(false)} />
          <ModalBody>
