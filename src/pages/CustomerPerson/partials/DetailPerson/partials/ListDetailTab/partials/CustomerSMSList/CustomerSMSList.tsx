        ...
        <div className="action-header">
          <div className="title__actions">
            <ul className="menu-list">
              <li className="active">Danh sách lịch sử gửi tin nhắn</li>
            </ul>
            <Tippy content="Gửi tin nhắn" delay={[100, 0]} animation="scale-extreme">
          ...
          <Fragment>
            {isNoItem && (
              <SystemNotification
                description={
                  <span>
                    Hiện tại chưa có lịch sử gửi tin nhắn nào.                    
                  </span>
                }
                type="no-item"
