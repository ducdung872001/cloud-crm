...
export default function ModalAddData({ onShow, onHide, dataProps, customerId }) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: Record<string, unknown> = {
      ...
      customerId,
      // transactionDate: formatDateCustom(formData.values.transactionDate, "yyyy-MM-dd HH:mm:ss"),
      ...
      actions_right: {
        buttons: [
          ...
          },
          {
            ...
            type: "submit",
            color: "primary",
            disabled: isEqual(formData.values, values) || (formData.errors && Object.keys(formData.errors).length > 0),
            is_loading: isSubmit,
          },
        ],
      },
