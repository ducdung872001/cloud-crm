...
import "./AddCustomPlaceholderModal.scss";

export default function AddCustomPlaceholderModal(props: ICustomPlaceholderModalProps) {
  ...
  return (
    <Fragment>
      ...
      >
        <form className="form-add-custom-placeholder" onSubmit={(e) => onSubmit(e)}>
