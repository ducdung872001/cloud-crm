...
export default function BuyingPotential(props) {
    ...
    if (chart && valueOption !== "excel") {
      ...
      chart.update({
        exporting: {
          ...
          filename: `${valueOption.startsWith("image") ? "Ảnh" : "Báo_cáo"}_tiềm_năng_mua_hàng`, // Tên file
  ...
  return (
    <div className="page__buying--potential">
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Tiềm năng mua hàng</h2>
        <div
