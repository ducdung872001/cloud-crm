...
import { IWarrantyStepRequest } from "model/warrantyStep/WarrantyStepRequestModel";
...
export default function AddStep(props: IStepModalProps) {
  ...
  const onSubmit = async (e) => {
    ...
    const body: IWarrantyStepRequest = {
      ...(formData as IWarrantyStepRequest),
      ...(data ? { id: data.id } : {}),
      unit: dataUnit?.value
    };    

    const response = await WarrantyStepService.update(body);
