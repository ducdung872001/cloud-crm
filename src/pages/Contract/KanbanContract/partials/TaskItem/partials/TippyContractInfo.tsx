  ...
  return (
    <div className="tippy_customer_info">
        ...
        <div style={{display:'flex',}}>
            <div>
                <span style={{fontSize: 12, fontWeight:'400'}}>Số điện thoại: {detailCustomer.customerPhone}</span>
            </div>
        </div>

        {detailCustomer.customerEmail &&
          <div>
              <span style={{fontSize: 12, fontWeight:'400'}}>Email: {detailCustomer.customerEmail}</span>
          </div>
        }
{/*        
        <div>
