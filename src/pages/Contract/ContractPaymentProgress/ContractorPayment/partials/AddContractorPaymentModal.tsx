...
export default function AddContractorPaymentModal(props: any) {
  ...
  const onSubmit = async (e) => {
    ...
    const response = await ContractorPaymentService.update(body);
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-add-contractor-payment"
        // size='lg'
      >
        <form className="form-contractor-payment-group" onSubmit={(e) => onSubmit(e)}>
          <ModalHeader
          ...
          />
          <ModalBody>
            <div className="list-form-group-contractor-payment">
