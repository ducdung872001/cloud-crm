...
export default function FilterContract(props: IAdvancedDateFilterProps) {
  ...
  const dateCalculation = (type) => {
    switch (type) {
      ...
      case "8": {
        const startDate = moment().startOf("year").format("DD/MM/yyyy");

        const endDate = moment().endOf("year").format("DD/MM/yyyy");
