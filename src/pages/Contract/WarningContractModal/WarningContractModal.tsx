...
import "./WarningContractModal.scss";
import ExpireTimeWarning from "./partials/ExpireTimeWarning/ExpireTimeWarning";
import ChangePriceWarning from "./partials/ChangePriceWarning/ChangePriceWarning";
import PaymentProgressWarning from "./partials/PaymentProgressWarning/PaymentProgressWarning";

export default function WarningContractModal(props: any) {
  ...
  return (
    <Fragment>
      <Modal
        ...
        className="modal-warning-contract"
        size="lg"
      >
        <form className="form-warning-contract">
          <ModalHeader
          ...
          <ModalBody>
            <div>
              ...
              <div className={tab === 3 ? "" : "d-none"}>
                <ChangePriceWarning dataContract={dataContract} onHide={() => {}} />
              </div>

              <div className={tab === 4 ? "" : "d-none"}>
                <PaymentProgressWarning dataContract={dataContract} onHide={() => {}} />
              </div>
            </div>
          </ModalBody>
