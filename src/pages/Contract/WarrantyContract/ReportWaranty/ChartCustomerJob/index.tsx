...
import ReportWarantyDetailModal from "../ReportWarantyDetailModal";
              ...
              data: [
                {
                  ...
                  y: data?.validCount || 0,
                  text: `${data?.validCount} bảo hành`,
                  events: {
                    legendItemClick: function (event) {
                      event.preventDefault();
                      setShowModalDetail(true);
                      setReportDetail("valid");
                      setReportDetailTitle("Danh sách bảo hành còn hạn > 30 ngày");
                    },
                  },
                },
                {
                  ...
                  text: `${data?.expiringCount} bảo hành`,
                  events: {
                    legendItemClick: function (event) {
                      event.preventDefault();
                      setShowModalDetail(true);
                ...
                },
                {
                  ...
                  text: `${data?.expiredCount} bảo hành`,
                  events: {
                    legendItemClick: function (event) {
                      event.preventDefault();
                      setShowModalDetail(true);
                      setReportDetail("expired");
                      setReportDetailTitle("Danh sách bảo hành đã hết hạn");
                    },
                  },
                },
              ],
  ...
  return (
    <div className="card-box page__customer--campaign chart-report__detail">
      <div className="title__common d-flex align-items-start">
        <h2 className="name-common">Thống kê số lượng bảo hành</h2>
        <div
