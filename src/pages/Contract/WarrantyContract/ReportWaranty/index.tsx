...
import ReportContractWarrantyService from "services/ReportContractWarrantyService";
...
export default function ReportWaranty() {
  ...
  const fetchData = async () => {
    const response = await ReportContractWarrantyService.reportContractWarranty(params);
    if (response.code === 0) {
