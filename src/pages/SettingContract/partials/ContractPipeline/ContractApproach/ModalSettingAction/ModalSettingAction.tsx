...
import "./ModalSettingAction.scss";
...
export default function ModalSettingActionApproach(props: any) {
    ...
    const getListActivityApproach = async (paramsSearch: any) => {
        ...
        const response = await ContractApproachService.activityList(paramsSearch, abortController.signal);
    ...
    const showDialogConfirmDelete = (item?: any) => {
        const contentDialog: IContentDialog = {
            ...
            defaultText: "Xóa",
            defaultAction: async () => {
                const response = await ContractApproachService.deleteActivity(item.id);
                if (response.code === 0) {
