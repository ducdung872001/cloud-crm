                    ...
                    <div className="cr-review-item__body">
                      ...
                      <div className="cr-review-item__footer">
                        ...
                        <div className="cr-review-item__actions">
                          {r.status === "pending" && (
                            <button className="cr-btn cr-btn--approve" onClick={() => showToast(`Đã duyệt đánh giá #${r.id} (demo)`, "info")}>Duyệt đăng</button>
                          )}
                      ...
                      {replyingId === r.id && (
                        <div className="cr-reply-box">
                          ...
                          <button className="cr-btn cr-btn--send" onClick={() => { showToast("Đã gửi phản hồi (demo)", "info"); setReplyingId(null); setReplyText(""); }}>Gửi</button>
                        </div>
                      )}
                    </div>
                  </div>
