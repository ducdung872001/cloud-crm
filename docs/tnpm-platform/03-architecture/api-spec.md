...
**Source**: HLD v2.0 ([`../99-source-archive/TNPM_HLD_v2.pdf`](../99-source-archive/TNPM_HLD_v2.pdf)) + 20 prototype pages on `reborn-tnpm` branch
**Note**: Bản gốc ngày 2026-04-14, các con số endpoint count đã được đối chiếu lại trong [`microservices.md`](./microservices.md) (đếm thực tế: 22% REUSE / 16% EXTEND / 62% NEW). Khi mâu thuẫn, dùng số trong `microservices.md`.
