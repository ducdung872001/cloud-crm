...
*Phiên bản: Community Hub — Tenant "W-House"*
...
Khi tài khoản của bạn được cấp nhiều vai trò khác nhau (ví dụ vừa là nhân viên lễ tân, vừa tham gia bộ phận quản lý), hệ thống sẽ hiện một cửa sổ **Chọn vai trò** ngay sau khi đăng nhập.
...
2. **Tên gói đang dùng**
   Ví dụ hiển thị *"W-House - Sử dụng gói vàng"*. Đây là tên tenant (đơn vị) và gói dịch vụ bạn đang thuê.

3. **Thanh tìm kiếm toàn cục**
   Gõ tên thành viên, dịch vụ hoặc mã đơn hàng để tìm nhanh mà không cần vào từng phân hệ.

4. **Tên cơ sở (ví dụ: W-House)**
   Nếu đơn vị bạn có nhiều cơ sở / tòa nhà/ địa điểm, bấm vào đây để chuyển đổi cơ sở làm việc. Mọi số liệu hiển thị sau đó sẽ theo cơ sở bạn vừa chọn.
