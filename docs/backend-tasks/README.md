...
| [error-input-wrong-vague.md](./inventory/error-input-wrong-vague.md) | 🟡 MEDIUM | Error `"Input wrong"` quá mơ hồ — không nói field nào sai (cross-cutting, cũng ảnh hưởng customer API) |
